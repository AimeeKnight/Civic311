...
exports.sendWelcome = function(data, fn){
  send({from:'admin@aimeemarieknight.us', to:data.to, subject:'Welcome to Civic311', template:'welcome'}, fn);
};
...
exports.sendAccess = function(data, fn){
  send({from:'admin@aimeemarieknight.us', to:data.to, token:data.token, subject:'Welcome to Civic311', template:'access'}, fn);
};
...
exports.sendUpdate = function(data, fn){
  send({from:'admin@aimeemarieknight.us', to:data.to, currentStatus:data.currentStatus, name:data.name, subject:'Civic311 Report Update', template:'update'}, fn);
};
